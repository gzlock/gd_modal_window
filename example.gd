...
@onready var pixel_style_switch: CheckButton = %PixelStyleSwitch
...
func _ready() -> void:
	...
	$UI/VBoxContainer/VBoxContainer1/Label.text = i18n.ui($UI/VBoxContainer/VBoxContainer1/Label.text)
	btn_win2.text = i18n.ui(btn_win2.text)
	$UI/VBoxContainer/VBoxContainer2/Label.text = i18n.ui($UI/VBoxContainer/VBoxContainer2/Label.text)
	btn_win3.text = i18n.ui(btn_win3.text)
	$UI/VBoxContainer/VBoxContainer3/Label.text = i18n.ui($UI/VBoxContainer/VBoxContainer3/Label.text)
	
	ModalWindowManager.children_visible_changed.connect(_modal_window_visible_changed)

# Pause the game
func _modal_window_visible_changed(_visible) -> void:
	if _visible:
